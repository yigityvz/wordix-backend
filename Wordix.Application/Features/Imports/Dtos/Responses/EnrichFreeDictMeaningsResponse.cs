...
/// <summary>
/// FreeDict English-Turkish meaning enrichment endpoint response modelidir.
/// 
/// Bu response hem FreeDict TEI XML parser sonucunu hem de database enrichment sonucunu birlikte raporlar.
/// </summary>
public sealed record EnrichFreeDictMeaningsResponse
{
    /// <summary>
    ...
    /// <summary>
    /// FreeDict parser genel olarak başarılı çalıştı mı?
    /// </summary>
    public bool ProviderSucceeded { get; init; }

    /// <summary>
    /// FreeDict parser tarafından üretilen toplam meaning row sayısıdır.
    /// </summary>
