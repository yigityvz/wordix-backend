...
public sealed class LookupResponse
{
    ...
    /// <summary>
    /// LearningItem'ın gerçek içerik kaynağıdır.
    /// 
    /// Örnek:
    /// - CefrJ
    /// - Octanove
    ...
    /// 
    /// Dikkat:
    /// LookupSource ile aynı şey değildir.
    /// LookupSource "sonuç nereden geldi?" bilgisidir.
    /// ContentSource ise "içerik ilk hangi kaynaktan üretildi?" bilgisidir.
    /// 
    /// Örnek:
    /// Azure ile oluşturulmuş bir phrase daha sonra DB'den bulunursa:
    /// - LookupSource = Database
    /// - ContentSource = AzureTranslator
    /// </summary>
    public string ContentSource { get; init; } = string.Empty;

    /// <summary>
    /// LearningItem'ın kalite/güven durumudur.
    /// 
    /// Örnek:
    /// - Verified
    /// - Imported
    ...
    /// <summary>
    /// LearningItem'ın sisteme hangi süreçle eklendiğini gösterir.
    /// 
    /// Örnek:
    /// - SystemSeed
    /// - Import
