...
/// <summary>
/// GetTopSavedLearningItemsQuery validation kurallarıdır.
/// </summary>
public sealed class GetTopSavedLearningItemsQueryValidator
    : AbstractValidator<GetTopSavedLearningItemsQuery>
{
    public GetTopSavedLearningItemsQueryValidator()
    {
        RuleFor(query => query)
