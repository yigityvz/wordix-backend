...
public sealed class LookupMeaningResponse
{
    ...
    /// <summary>
    /// Meaning verisinin gerçek kaynağıdır.
    /// 
    /// Örnek:
    /// - WiktionaryKaikki
    /// - AzureTranslator
    ...
    /// <summary>
    /// Meaning verisinin kalite/güven durumudur.
    /// 
    /// Örnek:
    /// - Imported
    /// - AutoGenerated
    ...
    /// <summary>
    /// Meaning'i sağlayan provider'ın okunabilir adıdır.
    /// 
    /// Örnek:
    /// - AzureTranslator
    /// - WiktionaryKaikki
    /// 
    /// Bazı manuel/seed kayıtlarında null olabilir.
    /// </summary>
