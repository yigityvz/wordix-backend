...
public class SentenceTranslationConfiguration : IEntityTypeConfiguration<SentenceTranslation>
{
    public void Configure(EntityTypeBuilder<SentenceTranslation> builder)
    {
        ...
        builder.Property(translation => translation.ContentSource)
            .HasConversion<int>()
            .IsRequired();

        builder.Property(translation => translation.QualityStatus)
            .HasConversion<int>()
            .IsRequired();
        ...
        // Çevirilerin gerçek kaynağına göre analiz yapılabilir.
        // Örnek: Tatoeba çevirileri, LibreTranslate çevirileri.
        builder.HasIndex(translation => translation.ContentSource);

        // Review/admin ekranında AutoGenerated veya NeedsReview çevirileri listelemek için kullanılır.
        builder.HasIndex(translation => translation.QualityStatus);
